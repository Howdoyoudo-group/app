...
const FeedCardNews = ({ id, title, source, url, timestamp, industry }: Props) => (
  <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
    <FeedSourceHero url={url} source={source} industry={industry} tint="amber" />
    <div className="p-4">
