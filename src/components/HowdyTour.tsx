...
const STOPS: Stop[] = [
  ...
  { route: "/my-jobs", title: "Howdy Jobs", line: "Swipe left to pass, right to like, or up to save. I’ve matched jobs based on who you are and what matters to you. Every swipe helps me get smarter." },
