...
const buildingCompanies = [
  ...
  { name: "Vistry Group", founded: "2020", hq: "Kings Hill", overview: "Created from the merger of Bovis Homes and Galliford Try's housebuilding arm, now a major affordable housing provider.", url: "https://www.vistrygroup.co.uk/careers", glassdoor: 3.4, valueChainStage: "Development & Land" },
