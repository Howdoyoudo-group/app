...
const deliveryCompanies = [
  ...
  { name: "DX Network Services", founded: "1975", hq: "Slough", glassdoor: 2.4, overview: "A UK and Ireland parcel, freight and logistics operator providing delivery services to business and residential customers through a national depot network.", url: "https://careers.dxdelivery.com/jobs/", valueChainStage: "Last Mile & Courier" },
];
