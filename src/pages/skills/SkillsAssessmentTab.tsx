...
import { CheckCircle2, AlertCircle, BookOpen, ArrowRight, Save, Star } from "lucide-react";
...
export default function SkillsAssessmentTab() {
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        <h2 className="font-display font-700 text-sm uppercase tracking-widest text-muted-foreground mb-1">Skills Assessment</h2>
