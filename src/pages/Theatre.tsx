...
const theatreCompanies = [
  ...
  { name: "London Youth Theatre", founded: "Registered charity", hq: "London", overview: "A youth theatre charity for 14-22 year olds, running onstage and backstage pathways alongside masterclasses from industry practitioners — a genuinely accessible first step into theatre before drama school, with most members joining for free.", url: "https://www.londonyouththeatre.org.uk", valueChainStage: "Performing" },
  { name: "Royal Opera House", founded: "1946", hq: "Covent Garden, London", overview: "Home to The Royal Opera and The Royal Ballet — a world-leading opera and ballet house with large in-house costume, scenic, music and stage management departments, plus a dedicated production facility at High House Production Park, Thurrock.", url: "https://www.rbo.org.uk/about/work-here", valueChainStage: "Producing & Theatre Administration" },
  { name: "TodayTix", founded: "2013", hq: "New York (London office)", overview: "Digital ticketing and discovery app for theatre, with a dedicated London office running marketing, product and technology roles alongside New York — acquired by Ari Emanuel's MARI in 2025.", url: "https://www.todaytixgroup.com/career-page.html", valueChainStage: "Front of House & Venue Operations" },
  { name: "See Tickets", founded: "2004", hq: "Nottingham (offices in London & LA)", overview: "One of the UK's largest ticketing companies, running box office and ticketing technology for West End theatre alongside music, sport and comedy — now owned by CTS Eventim.", url: "https://careers.seetickets.com/", valueChainStage: "Front of House & Venue Operations" },
];
