...
const beautyStages: CareerStage[] = [
  { title: "Product Development", icon: FlaskConical, roles: [
    ...
    { name: "Lab Technician", description: "Supports R&D by preparing samples, running stability tests, and documenting results.", salary: "£25k–£32k" },
  ]},
  ...
  { title: "Brand & Marketing", icon: Sparkles, roles: [
    ...
    { name: "Content Creator", description: "Produces photography, video, and editorial content to showcase products and tell brand stories.", salary: "£25k–£40k" },
    ...
    { name: "Visual Merchandiser", description: "Designs in-store displays, counter layouts, and point-of-sale experiences.", salary: "£25k–£38k" },
  ]},
  { title: "Retail & Sales", icon: Store, roles: [
    { name: "Beauty Advisor / Counter Manager", description: "Guides customers through products, demonstrates techniques, and drives in-store sales.", salary: "£25k–£32k" },
  ...
  { title: "Professional Services", icon: Brush, roles: [
    { name: "Makeup Artist", description: "Applies makeup for fashion shoots, film, TV, weddings, and editorial work.", salary: "£25k–£45k" },
    { name: "Hair Stylist", description: "Cuts, colours, and styles hair in salons, for events, or in editorial and media settings.", salary: "£25k–£40k" },
    { name: "Aesthetician / Skin Therapist", description: "Delivers facials, chemical peels, and skin treatments in clinics and spas.", salary: "£25k–£38k" },
    { name: "Nail Technician", description: "Provides manicures, pedicures, gel nails, and nail art in salons and freelance settings.", salary: "£25k–£30k" },
  ...
  { title: "Consumer & Community", icon: Heart, roles: [
    ...
    { name: "Brand Ambassador", description: "Represents a brand at events, launches, and in-store activations, embodying the brand identity.", salary: "£25k–£40k" },
