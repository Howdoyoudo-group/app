...
const healthCompanies = [
  ...
  { name: "Barchester Healthcare", url: "https://jobs.barchester.com/", founded: "1992", hq: "London", glassdoor: 3.4, overview: "One of the UK's largest care home operators, providing residential, nursing and dementia care alongside independent hospitals.", valueChainStage: "Care & Social Care" },
  { name: "Elysium Healthcare", url: "https://www.elysiumhealthcare.co.uk/careers/", founded: "2016", hq: "Borehamwood", glassdoor: 3.2, overview: "A UK provider of specialist mental health, neurological and complex care hospitals and services.", valueChainStage: "Care & Social Care" },
  { name: "Avery Healthcare", url: "https://jobsearch.averyhealthcare.co.uk/", founded: "2005", hq: "Northampton", glassdoor: 3.9, overview: "A UK care home group providing residential, nursing, dementia and respite care across England.", valueChainStage: "Care & Social Care" },
  ...
  { name: "HeliosX", url: "https://www.heliosx.com/#jobs", founded: "2013", hq: "London", overview: "Europe's largest telemedicine company - runs MedExpress, Dermatica, ZipHealth, RocketRx and Levity, prescribing and delivering care to 4m+ patients.", glassdoor: 3.5, valueChainStage: "MedTech, Biotech & Pharma" },
  { name: "Numan", url: "https://www.numan.com/careers", founded: "2018", hq: "London", overview: "Online men's health provider - diagnostics, prescription medication, supplements and clinician consultations via app.", valueChainStage: "MedTech, Biotech & Pharma" },
