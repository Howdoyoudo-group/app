...
const estateAgencyCompanies = [
  ...
  { name: "Purplebricks", url: "https://purplebricks.bamboohr.com/careers", founded: "2014", hq: "Solihull", glassdoor: 3.1, trustpilot: 3.9, profileUrl: "/company/purplebricks", overview: "The hybrid online agent that disrupted the market.", valueChainStage: "Sales & Lettings" },
