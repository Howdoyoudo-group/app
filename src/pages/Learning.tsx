...
const categories: Category[] = [
  ...
  },
  {
    ...
    resources: [
      {
        name: "Individual Placement Support (IPS)",
        description: "Evidence-based employment support for people with mental health conditions or serious mental illness - personalized job search, placement and ongoing support.",
        url: "https://www.rethink.org/information-and-support/living-with-mental-illness/employment/individual-placement-support/",
        tags: ["Mental Health", "Employment Support", "Funded"],
      },
      {
        name: "Remploy",
        description: "UK's largest provider of disability employment support - job coaching, workplace assessments, and ongoing support to help disabled people find and keep work.",
        url: "https://www.remploy.co.uk",
        tags: ["Disability", "Employment Support", "Job Coaching"],
      },
      {
        name: "Access to Work Scheme",
        description: "UK government grants to help disabled people overcome barriers to work - funding for equipment, transport, support workers and sign language interpreters.",
        url: "https://www.gov.uk/access-to-work",
        tags: ["Disability", "Funding", "Government"],
      },
      {
        name: "Supported Employment UK",
        description: "Network of supported employment providers across the UK, helping people with disabilities, mental health conditions and complex barriers find and sustain employment.",
        url: "https://www.supportedemploymentuk.org",
        tags: ["Employment Support", "Providers"],
      },
      {
        name: "The Spear Programme",
        description: "Intensive employment support for 16–24 year-olds - job coaching, mentoring, benefits advice and ongoing in-work support. One of UK's most effective youth employment schemes.",
        url: "https://www.spear.org.uk/spear-programme/",
        tags: ["Youth", "Employment Support", "Mentoring"],
      },
      {
        name: "Work and Health Unit - Condition Management Programmes",
        description: "NHS-supported work and health programmes helping people with health conditions get back to work or enter employment.",
        url: "https://www.gov.uk/government/collections/work-and-health-unit",
        tags: ["Health", "Work Support"],
      },
      {
        name: "ACAS - Disability at Work",
        description: "Free practical advice on disability rights at work, reasonable adjustments, and support for both employees and employers.",
        url: "https://www.acas.org.uk/disability-discrimination",
        tags: ["Rights", "Adjustments", "Free"],
      },
      {
        name: "Working Families",
        description: "Charity providing employment support for parents and carers - career advice, flexible working information and workplace rights.",
        url: "https://www.workingfamilies.org.uk",
        tags: ["Parents", "Carers", "Employment Support"],
      },
      {
        name: "DWP Kickstart Scheme",
        description: "Funded scheme creating jobs for young people aged 16-24 not in education, employment or training - six-month placements with employer support.",
        url: "https://www.gov.uk/government/collections/kickstart-scheme",
        tags: ["Youth", "Government", "Jobs"],
      },
      {
        name: "Traineeships",
        description: "UK government-funded work experience combined with training for young people aged 16-24. Six-month programmes with real employers.",
        url: "https://www.gov.uk/find-traineeship",
        tags: ["Youth", "Training", "Government"],
      },
      {
        name: "Prince's Trust Get Into Work",
        description: "Free support for young people aged 16-30 struggling to find work - training, mentoring and job placement support.",
        url: "https://www.princes-trust.org.uk/help-for-young-people/get-into-work",
        tags: ["Youth", "Free", "Mentoring"],
      },
      {
        name: "Momentum Skills - Benefits into Work",
        description: "Specialized employment support helping people on long-term benefits transition into sustainable work with ongoing coaching.",
        url: "https://momentumskills.com",
        tags: ["Benefits", "Employment Support"],
      },
    ],
  },
  {
