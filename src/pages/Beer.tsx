...
const beerCompanies = [
  ...
  { name: "Marston's", url: "https://www.marstons.co.uk/careers/", founded: "1834", hq: "Wolverhampton", glassdoor: 3.3, overview: "One of the UK's largest pub operators with a deep brewing heritage.", valueChainStage: "Taproom & Retail" },
