        ...
        <section className="px-4 sm:px-6 lg:px-10 pt-8 pb-16 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="border-2 border-border rounded-2xl p-6 md:p-8">
              ...
              <p className="font-body text-base text-muted-foreground mb-4 leading-relaxed">
                Watch <Link to="/the-show" className="text-primary font-600 hover:underline">The HDYD Show</Link> - episodes, pitches, street interviews and shorts from people doing jobs you may never have heard of. Prefer to read? Head to <Link to="/articles" className="text-primary font-600 hover:underline">Stuff We Rate</Link>. Watch, listen, read - whatever works for you. The goal is simple: stumble onto something you didn't know existed.
              </p>
            </div>
