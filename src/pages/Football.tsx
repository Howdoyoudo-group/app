...
const Football = () => {
  const tabs = [
    ...
    { id: "work", label: "Who?", content: (<><CompanyProfileGrid companies={footballCompanies} /><div className="mt-12"><DayInTheLife industry="football" /></div><div className="mt-12"><IndustryRolesLink industry="Football" /></div><div className="mt-12"><h2 className="font-display text-2xl md:text-3xl font-700 mb-6">Infographics<span className="text-primary">.</span></h2><img src={footballCareerMap} alt="Football career map infographic" className="w-full rounded-sm" loading="lazy" /></div></>) },
