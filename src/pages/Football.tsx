...
const footballCompanies = [
  ...
  { name: "Castore", url: "https://careers.castore.com/jobs", founded: "2015", hq: "Manchester", overview: "Premium British sportswear brand founded by brothers Tom and Phil Beahon - official kit supplier to a number of Premier League and international football clubs.", valueChainStage: "Kit & Merchandise" },
  ...
  { name: "Manchester City", url: "https://www.cityfootballgroup.com/careers", founded: "1880", hq: "Manchester", glassdoor: 3.9, overview: "Multiple Premier League and Champions League winners, run through City Football Group's global network.", valueChainStage: "Club Operations" },
  { name: "Newcastle United", url: "https://careers.newcastleunited.com", founded: "1892", hq: "Newcastle upon Tyne", glassdoor: 3.9, overview: "PIF-backed Geordie giants rebuilding at St James' Park with major investment across the club.", valueChainStage: "Club Operations" },
  { name: "Aston Villa", url: "https://careers.avfc.co.uk/jobs", founded: "1874", hq: "Birmingham", glassdoor: 3.8, overview: "One of English football's founding clubs, back competing in Europe under V Sports ownership.", valueChainStage: "Club Operations" },
  { name: "Everton", url: "https://careers.evertonfc.com", founded: "1878", hq: "Liverpool", glassdoor: 3.8, overview: "One of the league's founding members, now settled into the new Everton Stadium at Bramley-Moore Dock.", valueChainStage: "Club Operations" },
  { name: "Fulham", url: "https://www.fulhamfc.com/club/careers/", founded: "1879", hq: "London", glassdoor: 3.8, overview: "West London club at Craven Cottage, one of the Premier League's most consistently stable top-flight sides.", valueChainStage: "Club Operations" },
  { name: "Crystal Palace", url: "https://careers.cpfc.co.uk", founded: "1905", hq: "London", glassdoor: 3.8, overview: "South London club at Selhurst Park, known for its academy pipeline and passionate matchday support.", valueChainStage: "Club Operations" },
  { name: "Nottingham Forest", url: "https://careers.nottinghamforest.co.uk", founded: "1865", hq: "Nottingham", glassdoor: 3.8, overview: "Two-time European Cup winners in the 1970s and 80s, rebuilding at the City Ground under fresh investment.", valueChainStage: "Club Operations" },
  { name: "Brentford", url: "https://www.brentfordfc.com/en/careers", founded: "1889", hq: "London", glassdoor: 3.9, overview: "Data-driven recruitment pioneers who punched well above their budget to reach and stay in the Premier League.", valueChainStage: "Club Operations" },
  { name: "Bournemouth", url: "https://careers.afcb.co.uk", founded: "1899", hq: "Bournemouth", glassdoor: 3.9, overview: "South coast club known for smart recruitment and a tight-knit, community-focused operation.", valueChainStage: "Club Operations" },
  { name: "Leeds United", url: "https://www.leedsunited.com/en/club/careers", founded: "1919", hq: "Leeds", glassdoor: 3.7, overview: "Yorkshire giants back in the Premier League via the Championship play-offs, employing 270+ staff at Elland Road.", valueChainStage: "Club Operations" },
  { name: "Sunderland", url: "https://www.safc.com/club-information/careers/latest-vacancies", founded: "1879", hq: "Sunderland", glassdoor: 3.8, overview: "One of English football's best-supported clubs, back in the Premier League at the Stadium of Light.", valueChainStage: "Club Operations" },
