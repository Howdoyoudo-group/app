...
const carsCompanies = [
  ...
  { name: "Ohme", url: "https://ohme-ev.com/job-postings/", founded: "2017", hq: "London", overview: "Smart EV home-charging tech - makes its own smart charger plus an app that schedules charging around cheap and green electricity tariffs.", valueChainStage: "EV & Future Mobility" },
  { name: "Tesla", url: "https://www.tesla.com/en_GB/careers/search/?site=GB", founded: "2003", hq: "Austin, Texas", glassdoor: 3.5, overview: "An American electric vehicle and clean energy company that sells cars and operates supercharger infrastructure in the UK.", valueChainStage: "EV & Future Mobility" },
  { name: "Stellantis UK", url: "https://www.stellantis-careers.co.uk/", founded: "2021", hq: "Coventry", glassdoor: 3.6, overview: "A multinational automotive manufacturer whose UK brands include Vauxhall, Peugeot, Citroen and Fiat, with UK operations headquartered in Coventry.", valueChainStage: "Manufacturing" },
  { name: "Sytner Group", url: "https://jobs.sytner.co.uk/jobs/home/", founded: "1968", hq: "Leicester", glassdoor: 3.7, overview: "The UK's largest prestige and luxury car dealership group, representing brands including BMW, Mercedes-Benz and Audi.", valueChainStage: "Retail & Sales" },
  { name: "Listers Group", url: "https://careers.listers.co.uk/", founded: "1979", hq: "Stratford-upon-Avon", glassdoor: 3.7, overview: "A family-owned UK motor retail group operating dealerships for multiple car brands across England.", valueChainStage: "Retail & Sales" },
  ...
  { name: "Motorway", url: "https://careers.motorway.co.uk/", founded: "2017", hq: "London", overview: "Used-car selling marketplace - private sellers get a valuation online, then dealers bid against each other in a daily auction to buy the car directly.", valueChainStage: "Retail & Sales" },
  { name: "Carwow", url: "https://www.carwow.co.uk/jobs", founded: "2011", hq: "London", overview: "Online new-car marketplace and reverse-auction - buyers configure the car they want and dealers compete with direct offers.", valueChainStage: "Retail & Sales" },
  { name: "Carmoola", url: "https://apply.workable.com/carmoola-1/", founded: "2020", hq: "London", overview: "Car-finance fintech - app-based car loans that let buyers get approved and pay a dealer or private seller directly in minutes.", valueChainStage: "Retail & Sales" },
];
