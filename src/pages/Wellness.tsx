...
const wellnessStages: CareerStage[] = [
  { title: "Gyms & Fitness", icon: Dumbbell, roles: [
    ...
    { name: "Personal Trainer", description: "Designs and delivers tailored exercise programmes.", salary: "£25k–£50k" },
    { name: "Group Fitness Instructor", description: "Leads group exercise classes.", salary: "£25k–£35k" },
    { name: "Membership Sales Advisor", description: "Drives new member sign-ups and retention.", salary: "£25k–£35k" },
  ...
  { title: "Health & Wellbeing", icon: Heart, roles: [
    ...
    { name: "Wellness Coach", description: "Guides clients through holistic lifestyle changes.", salary: "£25k–£40k" },
    { name: "Yoga / Pilates Teacher", description: "Teaches mind-body movement classes.", salary: "£25k–£40k" },
    { name: "Sports Massage Therapist", description: "Uses soft tissue techniques for recovery.", salary: "£25k–£38k" },
    { name: "Mental Health & Wellbeing Lead", description: "Develops workplace mental health programmes.", salary: "£30k–£50k" },
    { name: "Holistic Therapist", description: "Offers complementary therapies.", salary: "£25k–£35k" },
  ]},
  ...
  { title: "Activewear & Apparel", icon: Shirt, roles: [
    ...
    { name: "Visual Merchandiser", description: "Creates in-store and online displays.", salary: "£25k–£38k" },
  ...
  { title: "Retail & Wellness", icon: ShoppingBag, roles: [
    { name: "Pharmacy Dispenser", description: "Assists pharmacists by preparing prescriptions.", salary: "£25k–£31k" },
    { name: "Beauty Advisor", description: "Provides expert skincare and beauty advice.", salary: "£25k–£26k" },
  ...
  { title: "Community & Experience", icon: Users, roles: [
    ...
    { name: "Events Coordinator", description: "Plans and delivers fitness events and retreats.", salary: "£25k–£38k" },
    { name: "Content Creator", description: "Produces content for wellness brands.", salary: "£25k–£42k" },
