...
const Marketplace = ({ embedded = false }: { embedded?: boolean } = {}) => {
  ...
  const ROLE_KEYWORDS: Record<string, string[]> = {
    ...
    // Building trades
    bricklayer: ['bricklayer', 'bricklaying', 'mason', 'brickwork', 'blocklaying', 'block layer', 'brick layer', 'stonemason', 'apprentice bricklayer', 'trainee bricklayer', 'brickwork technician'],
    carpenter: ['carpenter', 'joiner', 'joinery', 'timber frame', 'carpentry', 'cabinet maker', 'fitted furniture', 'woodworker', 'skilled carpenter', 'site carpenter', 'apprentice carpenter', 'first fix', 'second fix'],
    plasterer: ['plasterer', 'rendering', 'skimming', 'dry lining', 'drywall installer', 'renderer', 'plaster technician', 'internal plasterer', 'external plasterer', 'apprentice plasterer', 'finishing plaster'],
    groundworker: ['groundworker', 'groundworks', 'excavation', 'foundations', 'construction labourer', 'construction laborer', 'site labourer', 'site laborer', 'groundwork labourer', 'drainage labourer', 'site operative', 'trainee groundworker', 'civil engineering labourer'],
    roofer: ['roofer', 'roofing', 'tiler', 'slater', 'felt roofer', 'roof technician', 'roofing technician', 'slate roof', 'roof tiler', 'apprentice roofer', 'flat roofing', 'pitched roofing'],
    // Fixing trades
    electrician: ['electrician', 'electrical engineer', 'electrical fitter', 'electrical technician', 'installation electrician', 'solar panel installer', 'ev charger installer', 'sparky', 'part p', '18th edition', 'domestic electrician', 'commercial electrician', 'qualified electrician', 'maintenance electrician', 'apprentice electrician', 'trainee electrician', 'rewiring', 'electrical installation'],
    plumber: ['plumber', 'plumbing', 'pipefitter', 'bathroom fitter', 'water systems', 'pipe fitter', 'plumbing technician', 'service plumber', 'domestic plumber', 'commercial plumber', 'qualified plumber', 'gas plumber', 'apprentice plumber', 'plumbing engineer', 'heating plumber', 'drainage', 'drainage technician', 'bathroom installer', 'pipework', 'water fitter', 'trainee plumber', 'central heating installer', 'sanitary ware installer'],
    'heating-engineer': ['gas engineer', 'gas safe', 'heat pump engineer', 'hvac engineer', 'heating and ventilation', 'boiler engineer', 'boiler technician', 'heating engineer', 'central heating engineer', 'service technician heating', 'installation engineer heating', 'apprentice gas engineer', 'boiler installer', 'heating installation', 'plumbing and heating'],
    'repair-technician': ['repair technician', 'appliance repair', 'mobile phone repair', 'electronics repair', 'white goods engineer', 'service engineer', 'technician repairs', 'fix appliances', 'appliance technician', 'repair specialist', 'maintenance engineer', 'field service engineer', 'service and repair'],
    handyperson: ['handyperson', 'handyman', 'multi-trade engineer', 'maintenance technician', 'odd jobs', 'general maintenance', 'handy person', 'multi-skilled maintenance', 'maintenance worker', 'maintenance assistant', 'general operative', 'facilities maintenance'],
    // Politics
    'policy-advisor': ['policy advisor', 'policy officer', 'policy manager', 'civil servant', 'government advisor', 'fast stream', 'government economist', 'senior civil servant', 'policy development', 'government delivery', 'cabinet office', 'whitehall'],
    'parliamentary-researcher': ['parliamentary researcher', 'parliamentary assistant', 'caseworker', 'chief of staff office', 'special adviser', 'spad', 'mp researcher', 'house of commons', 'westminster', 'mp assistant', 'office manager mp'],
    'council-officer': ['council officer', 'planning officer', 'environmental health officer', 'electoral services', 'democratic services', 'housing officer', 'local government', 'local authority', 'council employee', 'planning technician', 'council administrator'],
    'think-tank-researcher': ['think tank', 'research fellow', 'research assistant', 'policy institute', 'programme manager', 'policy research', 'research analyst', 'institute researcher', 'policy analysis'],
    'public-affairs-manager': ['public affairs', 'government relations', 'public affairs consultant', 'lobbyist', 'political consultant', 'government relations manager', 'external affairs', 'stakeholder relations', 'regulatory affairs'],
    // Theatre
    performer: ['actor', 'actress', 'performer', 'dancer', 'singer', 'musical theatre', 'ensemble', 'understudy', 'swing', 'stage performer', 'theatre actor', 'theatre performer', 'stage actor', 'production performer', 'theatre artist'],
    'theatre-stage-manager': ['stage manager', 'assistant stage manager', 'asm', 'deputy stage manager', 'dsm', 'company manager theatre', 'production manager theatre', 'stage management', 'theatre management', 'stage production manager'],
    'theatre-technician': ['theatre technician', 'lighting technician', 'lx tech', 'sound engineer theatre', 'av technician', 'rigger', 'stage crew', 'technical crew theatre', 'lighting designer', 'sound designer theatre', 'technical support theatre'],
    'theatre-costume-designer': ['costume designer', 'wardrobe supervisor', 'set designer', 'scenic designer', 'wigs hair makeup', 'theatre designer', 'props master', 'production designer', 'scenic artist', 'design production', 'theatre design'],
    'theatre-producer': ['theatre producer', 'general manager theatre', 'casting director', 'literary manager', 'dramaturg', 'theatre administrator', 'theatre management', 'production company', 'theatre operations'],
  };
