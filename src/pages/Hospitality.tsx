...
const hospitalityCompanies = [
  ...
  { name: "Five Guys", url: "https://jobs.fiveguys.co.uk/jobs/home/", founded: "1986", hq: "Virginia (UK: London)", glassdoor: 3.5, trustpilot: 2.8, profileUrl: "/company/five-guys", overview: "A family-founded burger chain obsessed with simplicity.", valueChainStage: "Restaurant & QSR" },
  ...
  { name: "Stonegate Group", url: "https://www.stonegatecareers.co.uk/", founded: "2010", hq: "Solihull", glassdoor: 3.3, overview: "The UK's largest pub company, operating thousands of managed pubs, bars and late-night venues including Slug & Lettuce and Popworld.", valueChainStage: "Hotels & Members' Clubs" },
  { name: "PPHE Hotel Group", url: "https://jobs.pphe.com/careers/", founded: "1989", hq: "Amsterdam", glassdoor: 3.4, overview: "An international hotel group that owns and operates hotels across Europe, including the Park Plaza and art'otel brands, with a significant UK presence in London.", valueChainStage: "Hotels & Members' Clubs" },
  { name: "Booker Group", url: "https://www.bookergroupjobs.co.uk", founded: "1835", hq: "Wellingborough", glassdoor: 2.7, overview: "The UK's leading food and drink wholesaler, operating cash-and-carry branches and delivered wholesale under brands including Booker, Makro and Booker Direct, and owned by Tesco.", valueChainStage: "Supply Chain" },
  { name: "Restaurant Associates", url: "https://jobs.compass-group.co.uk/restaurant-associates", founded: "2001", hq: "London", glassdoor: 3.9, overview: "A UK contract catering and hospitality business, part of Compass Group, providing workplace dining and guest services at corporate, cultural and heritage venues.", valueChainStage: "Restaurant & QSR" },
];
