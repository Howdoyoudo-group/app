...
const hospitalityStages: CareerStage[] = [
  ...
  { title: "Kitchen", icon: ChefHat, roles: [
    ...
    { name: "Pastry Chef", description: "Specialises in desserts, bread, and pastry production.", salary: "£24k–£38k" },
    { name: "Kitchen Porter", description: "Maintains kitchen cleanliness and supports chefs.", salary: "£20k–£24k" },
  ...
  { title: "Front of House", icon: ConciergeBell, roles: [
    ...
    { name: "Head Waiter", description: "Leads the floor team during service.", salary: "£24k–£32k" },
    { name: "Sommelier", description: "Curates the wine list and advises guests on pairings.", salary: "£26k–£45k" },
    { name: "Barista", description: "Prepares espresso-based drinks and other beverages.", salary: "£21k–£28k" },
    { name: "Bartender / Mixologist", description: "Creates and serves cocktails, manages the bar.", salary: "£22k–£32k" },
    { name: "Host / Receptionist", description: "Greets guests and manages reservations.", salary: "£21k–£26k" },
  ]},
  { title: "Supply Chain", icon: Truck, roles: [
    ...
    { name: "Inventory Controller", description: "Tracks stock levels, manages ordering, and minimises waste.", salary: "£24k–£35k" },
    { name: "Delivery Coordinator", description: "Schedules and manages deliveries to venues.", salary: "£22k–£32k" },
  ...
  { title: "Marketing", icon: Megaphone, roles: [
    ...
    { name: "Events Coordinator", description: "Plans and delivers private events, pop-ups, and promotional activities.", salary: "£24k–£38k" },
    { name: "Content Photographer", description: "Shoots food, interiors, and lifestyle imagery.", salary: "£25k–£45k" },
    { name: "Community Manager", description: "Builds local community engagement.", salary: "£24k–£38k" },
