...
const moneyCompanies = [
  ...
  { name: "Tide", url: "https://www.tide.co/careers/", founded: "2015", hq: "London", overview: "Digital business banking platform for UK SMEs - current accounts, invoicing, expense management and admin tools.", valueChainStage: "FinTech & Payments" },
  { name: "GoCardless", url: "https://gocardless.com/jobs/", founded: "2011", hq: "London", overview: "Account-to-account payments network - recurring Direct Debit collection and Open Banking payments for 65,000+ businesses.", valueChainStage: "FinTech & Payments" },
  { name: "Zopa", url: "https://careers.zopa.com/work-with-us", founded: "2005", hq: "London", overview: "Digital bank offering personal loans, credit cards and savings accounts - originally the world's first peer-to-peer lender.", valueChainStage: "FinTech & Payments" },
  { name: "Thought Machine", url: "https://www.thoughtmachine.net/careers", founded: "2014", hq: "London", overview: "Cloud-native core banking and payments technology - Vault Core platform used by major banks to replace legacy mainframes.", valueChainStage: "FinTech & Payments" },
  { name: "Marshmallow", url: "https://www.marshmallow.com/jobs", founded: "2017", hq: "London", overview: "Digital car insurer using machine learning and alternative data to price cover fairly for migrants and others underserved by traditional insurers.", valueChainStage: "FinTech & Payments" },
  { name: "Griffin", url: "https://www.griffin.com/careers", founded: "2017", hq: "London", overview: "API-first banking-as-a-service platform - regulated bank accounts, payments and compliance infrastructure for fintechs, with a full UK banking licence.", valueChainStage: "FinTech & Payments" },
