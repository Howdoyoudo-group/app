...
const TILES: Array<{
  title: string; desc: string; href: string; Icon: React.ElementType; img?: string;
}> = [
  { title: "What We Know", desc: "Your profile & signals", href: "/my-profile", Icon: Layers },
  { title: "Howdy Jobs", desc: "Jobs ranked for you", href: "/my-jobs?tab=jobs", Icon: Briefcase, img: howdyMascot },
  { title: "Suggested Roles", desc: "Roles from your CV", href: "/match-me/suggested-roles", Icon: Briefcase },
  { title: "Suggested Industries", desc: "Industries from your CV", href: "/match-me/suggested-industries", Icon: Building2 },
  { title: "Worlds Collide", desc: "Crossover roles", href: "/match-me/worlds-collide", Icon: Shuffle },
  { title: "What If Machine", desc: "Explore any combination", href: "/match-me/what-if-machine", Icon: Brain },
  { title: "Side Hustles", desc: "Matched to your skills", href: "/side-hustles", Icon: Wallet },
];
