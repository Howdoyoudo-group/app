...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "HR Coordinator", description: "Supports the HR team with admin, onboarding, and employee queries.", salary: "£25k–£28k" },
    { name: "Recruitment Coordinator", description: "Manages job postings, screens candidates, and coordinates interviews.", salary: "£25k–£30k" },
  ]},
...
const HRPeople = () => {
  ...
  return <RolePageLayout slug="hr-people" name="People & Culture" description="Recruitment, culture, and talent development - the people who look after the people." tabs={tabs} category="business" />;
};
