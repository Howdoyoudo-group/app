...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Coffee, roles: [
    { name: "Barista", description: "Prepares espresso-based drinks, steams milk, and delivers great customer service.", salary: "£20k–£24k" },
    { name: "Trainee Barista", description: "Learns espresso technique, drink recipes, and café operations.", salary: "£18k–£22k" },
  ]},
  { title: "Mid Level", icon: Target, roles: [
    { name: "Senior Barista / Shift Supervisor", description: "Leads shifts, trains new baristas, and ensures quality and service standards.", salary: "£24k–£30k" },
