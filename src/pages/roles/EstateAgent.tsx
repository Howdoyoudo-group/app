...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Home, roles: [
    { name: "Trainee Estate Agent", description: "Conducts viewings, registers applicants, and learns the property market.", salary: "£25k–£31k + commission" },
    { name: "Lettings Negotiator", description: "Matches tenants with properties and manages the letting process.", salary: "£25k–£26k + commission" },
  ]},
