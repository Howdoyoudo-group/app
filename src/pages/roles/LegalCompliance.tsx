...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "Legal Assistant / Paralegal", description: "Supports lawyers with research, document drafting, and case management.", salary: "£25k–£30k" },
    { name: "Compliance Coordinator", description: "Assists with regulatory monitoring, policy documentation, and audit preparation.", salary: "£25k–£32k" },
  ]},
