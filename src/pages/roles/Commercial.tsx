...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    ...
    { name: "Commercial Coordinator", description: "Supports commercial teams with contracts, reporting, and partner liaison.", salary: "£25k–£30k" },
  ]},
