...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Clapperboard, roles: [
    { name: "Runner / Production Assistant", description: "Supports the production team on set or in the studio with logistics and admin.", salary: "£18k–£24k" },
    { name: "Junior Producer", description: "Assists with scheduling, budgets, and coordinating talent and crew.", salary: "£22k–£28k" },
  ]},
