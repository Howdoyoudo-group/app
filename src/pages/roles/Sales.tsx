...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "Sales Assistant / SDR", description: "Generates leads, qualifies prospects, and books meetings for senior salespeople.", salary: "£22k–£30k" },
