...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "Junior Designer", description: "Creates assets under direction - layouts, social graphics, and brand collateral.", salary: "£25k–£30k" },
    { name: "Design Intern", description: "Assists the creative team with production work, mood boards, and concept development.", salary: "£25k–£30k" },
  ]},
