...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: ShoppingBag, roles: [
    { name: "Sales Assistant / Store Colleague", description: "Till work, restocking, customer service on the shop floor.", salary: "£11–£13/hr (£20k–£24k)" },
    { name: "Visual Merchandiser (Junior)", description: "Window displays, in-store layouts, and product presentation.", salary: "£22k–£26k" },
  ]},
  { title: "Mid Level", icon: Target, roles: [
    { name: "Supervisor / Team Leader", description: "Runs a shift, manages the team on the floor and handles escalations.", salary: "£24k–£30k" },
