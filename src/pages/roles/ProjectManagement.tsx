...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "Project Coordinator", description: "Supports project managers with scheduling, tracking, and stakeholder communication.", salary: "£24k–£32k" },
