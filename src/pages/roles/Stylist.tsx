...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Scissors, roles: [
    { name: "Styling Assistant", description: "Pulls samples, steams garments, and assists stylists on shoots and shows.", salary: "£25k–£31k" },
    { name: "Junior Designer", description: "Assists with mood boards, fabric sourcing, and design development.", salary: "£25k–£28k" },
  ]},
