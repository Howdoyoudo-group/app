...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Package, roles: [
    { name: "Warehouse Operative / Picker", description: "Picks, packs and labels orders for dispatch - the heart of every fulfilment centre.", salary: "£13–£14/hr (£25k–£27k)" },
    { name: "Delivery Driver / Rider", description: "Last-mile delivery for grocery, fashion, and food brands.", salary: "£25k–£30k" },
  ]},
