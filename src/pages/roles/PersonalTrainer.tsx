...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Dumbbell, roles: [
    { name: "Fitness Instructor", description: "Delivers group classes and gym floor support, building foundational coaching skills.", salary: "£18k–£24k" },
    { name: "Junior Personal Trainer", description: "Works with clients 1-to-1 on fitness goals, building a client base.", salary: "£20k–£28k" },
  ]},
