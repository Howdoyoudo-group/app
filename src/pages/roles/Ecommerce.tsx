...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Target, roles: [
    { name: "E-commerce Coordinator", description: "Manages product listings, site updates, and assists with online trading.", salary: "£25k–£30k" },
    { name: "Digital Merchandiser", description: "Curates online product ranges and optimises site layout for conversion.", salary: "£25k–£32k" },
  ]},
