...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Wheat, roles: [
    { name: "Farm Worker / General Operative", description: "Hands-on day work - livestock, crops, machinery, fencing and seasonal harvest.", salary: "£25k–£28k" },
