...
const ITTechnology = () => {
  ...
  return <RolePageLayout slug="it-technology" name="IT & Technology" description="The people who build and run the software, data, and infrastructure behind every modern business - engineering, data, AI, and platform." tabs={tabs} category="business" />;
};
