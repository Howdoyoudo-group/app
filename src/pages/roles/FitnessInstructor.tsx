...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Dumbbell, roles: [
    { name: "Gym Floor Instructor", description: "Inducts new members, runs basic programmes, and supports the gym floor.", salary: "£18k–£22k" },
    { name: "Group Exercise Instructor", description: "Delivers group classes - spin, HIIT, yoga, strength.", salary: "£20k–£26k" },
  ]},
  { title: "Mid Level", icon: Target, roles: [
    { name: "Fitness Instructor", description: "Leads programmes, builds member relationships, and delivers a varied class timetable.", salary: "£22k–£30k" },
