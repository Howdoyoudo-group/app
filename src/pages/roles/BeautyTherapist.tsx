...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Sparkles, roles: [
    { name: "Beauty Therapist (Level 2)", description: "Facials, waxing, manicures and pedicures in a salon, spa or counter setting.", salary: "£25k–£30k" },
    { name: "Counter Beauty Advisor", description: "Brand counter (Boots, Selfridges, John Lewis) - sales, demos and consultations.", salary: "£25k–£26k" },
  ]},
  { title: "Mid Level", icon: Target, roles: [
    { name: "Senior Beauty Therapist (Level 3+)", description: "Advanced treatments - body, electrical, aesthetics support.", salary: "£25k–£30k" },
