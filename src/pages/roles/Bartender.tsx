...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: GlassWater, roles: [
    { name: "Waiter / Front of House", description: "Service on the floor - taking orders, running food, looking after guests.", salary: "£25k–£26k (+ tips)" },
    { name: "Barback", description: "Supports the bar - restocks, glassware, and learning the craft.", salary: "£25k–£29k (+ tips)" },
  ]},
