...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: ChefHat, roles: [
    { name: "Commis Chef", description: "Prepares ingredients, assists senior chefs, and learns kitchen disciplines.", salary: "£25k–£29k" },
    ...
    { name: "Baker (Junior)", description: "Mixes, proves, and bakes under supervision, learning recipes and techniques.", salary: "£25k–£29k" },
  ]},
  { title: "Mid Level", icon: Target, roles: [
    { name: "Chef de Partie", description: "Runs a section of the kitchen - starters, mains, or pastry.", salary: "£25k–£30k" },
