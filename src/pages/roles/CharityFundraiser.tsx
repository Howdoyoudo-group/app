...
const careerStages: CareerStage[] = [
  { title: "Entry Level", icon: Heart, roles: [
    { name: "Fundraising Assistant", description: "Supports a fundraising team with admin, donor communications, and events.", salary: "£25k–£26k" },
    { name: "Community Fundraiser", description: "Builds local supporter networks - runs, bake sales, school appeals.", salary: "£25k–£30k" },
  ]},
