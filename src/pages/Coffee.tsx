...
const coffeeStages: CareerStage[] = [
  { title: "Farm & Origin", icon: Sprout, roles: [
    { name: "Coffee Farmer", description: "Grows and harvests coffee cherries, managing crop cycles, soil health, and processing at origin.", salary: "£25k–£35k" },
  ...
  { title: "Processing", icon: Factory, roles: [
    ...
    { name: "Wet Mill Operator", description: "Operates washing stations where coffee cherries are pulped, fermented, and washed before drying.", salary: "£25k–£32k" },
    { name: "Dry Mill Operator", description: "Runs the dry mill where parchment coffee is hulled, sorted, and graded for export.", salary: "£25k–£32k" },
...
{ name: "Import Specialist", description: "Manages the import of green coffee into the UK, handling regulatory compliance and logistics.", salary: "£28k–£45k" },
  ...
  { title: "Roasting", icon: Flame, roles: [
    ...
    { name: "Production Roaster", description: "Operates roasting equipment on a daily basis, following profiles and monitoring batch quality.", salary: "£25k–£35k" },
    { name: "Sample Roaster", description: "Roasts small batches for quality evaluation and cupping, helping select and approve new lots.", salary: "£25k–£35k" },
    ...
    { name: "Packaging Technician", description: "Manages coffee packaging lines, ensuring proper sealing, labelling, and freshness preservation.", salary: "£25k–£30k" },
  ...
  { title: "Distribution", icon: Truck, roles: [
    ...
    { name: "Logistics Coordinator", description: "Coordinates deliveries between roasteries, warehouses, and customers across the UK.", salary: "£25k–£35k" },
  ...
  { title: "Retail & Café", icon: Store, roles: [
    ...
    { name: "Head Barista", description: "Leads the bar, trains junior baristas, and ensures drink quality and consistency.", salary: "£25k–£32k" },
    ...
    { name: "Shift Supervisor", description: "Manages the café team during a shift, handling service, cash, and problem-solving.", salary: "£25k–£30k" },
  ...
  { title: "Cup & Consumer", icon: CoffeeIcon, roles: [
    ...
    { name: "Content Creator", description: "Produces photography, video, and written content to tell the brand's story across channels.", salary: "£25k–£40k" },
    ...
    { name: "Events Coordinator", description: "Plans and delivers tastings, pop-ups, latte art competitions, and brand events.", salary: "£25k–£36k" },
