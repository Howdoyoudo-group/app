...
const interiorDesignStages: CareerStage[] = [
  { title: "Brief & Research", icon: FileText, roles: [
    ...
    { name: "Design Researcher", description: "Researches materials, trends, and precedents to inform design concepts.", salary: "£24k–£38k" },
    { name: "Space Planner", description: "Analyses and optimises spatial layouts for functionality and flow.", salary: "£28k–£45k" },
    { name: "Project Coordinator", description: "Supports the project manager with scheduling and documentation.", salary: "£24k–£35k" },
  ...
  { title: "Concept", icon: Lightbulb, roles: [
    ...
    { name: "Mood Board Designer", description: "Creates visual presentations communicating design direction.", salary: "£22k–£35k" },
  ...
  { title: "Design Development", icon: Ruler, roles: [
    ...
    { name: "CAD Technician", description: "Produces detailed technical drawings.", salary: "£24k–£38k" },
  ...
  { title: "Procurement", icon: ShoppingBag, roles: [
    ...
    { name: "Fabric Sourcer", description: "Sources upholstery fabrics and soft furnishings.", salary: "£24k–£38k" },
    ...
    { name: "Sample Librarian", description: "Manages the studio's material sample library.", salary: "£22k–£30k" },
  ...
  { title: "Build & Install", icon: Hammer, roles: [
    ...
    { name: "Upholsterer", description: "Covers and restores furniture with fabric and leather.", salary: "£24k–£38k" },
  ...
  { title: "Handover & Styling", icon: CheckCircle, roles: [
    { name: "Stylist", description: "Dresses and accessorises completed spaces.", salary: "£24k–£42k" },
    ...
    { name: "Property Stager", description: "Furnishes and styles properties for sale or rental.", salary: "£24k–£40k" },
