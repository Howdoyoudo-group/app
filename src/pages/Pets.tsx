...
const petsCompanies = [
  ...
  { name: "TrustedHousesitters", url: "https://www.trustedhousesitters.com/about/careers/", founded: "2010", hq: "Brighton", overview: "Membership platform matching pet owners with vetted sitters, who provide free home and pet care in exchange for free accommodation.", valueChainStage: "Pet Services & Wellbeing" },
  ...
  { name: "Tailster", url: "https://www.tailster.com/sign-up?state=carerSignup", founded: "2013", hq: "London", glassdoor: 3.1, overview: "A UK online platform connecting pet owners with vetted, insured dog walkers, sitters and boarders.", valueChainStage: "Pet Services & Wellbeing" },
  { name: "Goddard Veterinary Group", url: "https://www.goddardvetgroup.co.uk/veterinary-professionals/working-for-goddard/vacancies/", founded: "1952", hq: "London", glassdoor: 3.1, overview: "A London-based veterinary group operating practices and hospitals for companion animals across Greater London and the home counties.", valueChainStage: "Veterinary & Animal Health" },
  { name: "Animal Trust", url: "https://www.animaltrust.org.uk/careers/vacancies", founded: "2012", hq: "Ellesmere Port", glassdoor: 2.8, overview: "A UK not-for-profit veterinary practice group operating as a Community Interest Company, providing veterinary care without shareholder profit distribution.", valueChainStage: "Veterinary & Animal Health" },
  { name: "Cats Protection", url: "https://careers.cats.org.uk/", founded: "1927", hq: "Haywards Heath", glassdoor: 4.0, overview: "A UK charity dedicated to rescuing, rehoming and neutering cats, and educating people about cat welfare, operating shops, centres and volunteer branches nationwide.", valueChainStage: "Pet Services & Wellbeing" },
];
