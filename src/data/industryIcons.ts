...
export const INDUSTRY_ICONS: Record<string, string> = {
  ...
  "Beer": seriesBeer,
  "Cars": seriesCars,
  "Charity": seriesCharity,
  "Film and TV": seriesCinema,
  "Coffee": seriesCoffee,
  "Estate Agency": seriesEstateAgency,
  "Farming": seriesFarming,
  "Fashion": seriesFashion,
  "Football": seriesFootball,
  "Formula 1": seriesFormula1,
  "Footwear": seriesFootwear,
  "Gaming": seriesGaming,
  "Grocery": seriesGrocery,
  "Health": seriesHealth,
  "Horse Racing": seriesHorseRacing,
  "Hospitality": seriesHospitality,
  "Influencing": seriesInfluencing,
  "Interior Design": seriesInteriorDesign,
  "Jewellery": seriesJewellery,
  "Journalism": seriesJournalism,
  "Money": seriesMoney,
  "Music": seriesMusic,
  "Pets": seriesPets,
  "Physiotherapy": seriesPhysiotherapy,
  "Psychotherapy": seriesPsychotherapy,
