...
export const coursesByIndustry: Record<string, Course[]> = {
  ...
  cinema: [
    ...
    { title: "Short Courses", provider: "National Film & Television School", url: "https://nfts.co.uk/nfts-short-courses", description: "Short courses from the UK's leading film school.", free: false },
    ...
    { title: "Broadcast Media Training", provider: "MAMA Youth Project", url: "https://www.mamayouth.org.uk/", description: "Free hands-on scheme for 18-25s facing barriers to work - teams make a real TV programme on a live production schedule, with personal development support and help into broadcast and media jobs. London, Birmingham and Manchester.", free: true },
    { title: "4Skills Work Experience", provider: "Channel 4", url: "https://careers.channel4.com/4skills/work-experience", description: "Channel 4's free online work experience programme - true-to-life tasks set by Channel 4 teams, behind-the-scenes insight into TV and the wider creative industries, and a look at where your skills could fit. Self-paced, UK-wide.", free: true },
  ],
  coffee: [
  ...
  fixing: [
    { title: "Plumbing and Domestic Heating (9189)", provider: "City & Guilds", url: "https://www.cityandguilds.com/qualifications-and-apprenticeships/building-services-industry/plumbing/9189-plumbing-and-domestic-heating", description: "The core UK qualification route into plumbing and domestic heating, usually studied alongside an apprenticeship.", free: false },
    { title: "Electrical Installation (2366)", provider: "City & Guilds", url: "https://www.cityandguilds.com/qualifications-and-apprenticeships/building-services-industry/electrical-installation/2366-level-3-technical-occupational-entry-in-electrical-installation-diploma", description: "Industry-standard electrical installation qualifications - the route to becoming a qualified electrician.", free: false },
  ...
  theatre: [
    ...
    { title: "LYT Onstage & Backstage", provider: "London Youth Theatre", url: "https://www.londonyouththeatre.org.uk", description: "Performing and technical theatre pathways for 14-22 year olds - three full productions a year plus masterclasses with industry practitioners. Most members join for free.", free: true },
