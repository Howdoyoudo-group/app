...
export const RESOURCE_TOPICS: ResourceTopic[] = [
  ...
  },
  {
    ...
    help: [
      ...
      { name: "Vinspired", description: "UK volunteering platform for young people (14-25) — filter roles by cause and by the skills you'll build, from fundraising to public speaking.", url: "https://vinspired.com", tags: ["UK", "Young people", "Find roles"] },
